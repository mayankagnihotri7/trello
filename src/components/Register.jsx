...
export default class Register extends Component {
  ...
  handleSubmit = () => {
    axios
      .post("http://localhost:4000/api/users", { user: this.state })
      ...
      <div className="register-background">
        <div className="container-register">
          ...
          <div className="register-form">
            <h1 className="register-header">Sign up for your account</h1>
            <input
              type="email"
              name="email"
            ...
            <div className="register-form_footer">
              <h4>
                ...
                <span className="register-pre_button">Terms of Service</span>{" "}
                and <span className="register-pre_button">Privacy Policy.</span>
              </h4>
            </div>
            <button className="btn-submit" onClick={this.handleSubmit}>
              Continue
            </button>
            <div className="register-form_footer text-align">
              <h4>
                Already have an account?
                <br />
                <Link to="/login">
                  <span className="register-pre_button">Log In.</span>
                </Link>
              </h4>
            </div>
          </div>
